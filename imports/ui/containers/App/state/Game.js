...
export default class extends Phaser.State {
  ...
  update() {
    ...
    this.physics.arcade.collide(
      this.player,
      this.platforms,
      this.collisionHandlerPlayerPlatform,
      null,
      this
    );
    this.physics.arcade.collide(
      this.bullets,
      this.platforms,
      this.collisionHandlerBulletPlatform,
      null,
      this
    );
    this.physics.arcade.collide(
      this.DJbullets,
      this.platforms,
      this.collisionHandlerDJBulletPlatform,
      null,
      this
    );
    ...
    for (dj in this.djObjects) {
      if (
        this.physics.arcade.collide(
          this.bullets,
          this.djObjects[dj],
          this.collisionHandlerBulletDJ,
          this.collisionProccessorBulletDJ,
          this
        )
      ) {
  ...
  fireBullet(facing) {
    ...
    if (this.game.time.now > this.bulletTime) {
      ...
      if (bullet) {
        ...
        Streamy.emit("bulletFire", {
          data: { bulletx: this.player.x, bullety: this.player.y, facing },
          id: Streamy.id()
        });
  ...
  createBulletSettings() {
    ...
    this.DJbullets.setAll("anchor.x", 0.5);
    this.DJbullets.setAll("anchor.y", 0.5);
